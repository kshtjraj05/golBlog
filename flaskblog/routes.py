...
from flaskblog.forms import ResetPasswordForm, RequestResetForm, PostForm,RegistrationForm, LogIn, UpdateAccountForm
...
def send_reset_email(user):
    ...
    If you do not make this request then simply igore this email and
